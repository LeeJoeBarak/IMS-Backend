...
from users.models import ProgramCoordinator, ProgramManager, Student, Company
...
class StudentProfile(models.Model):
    ...
    phone_number = models.CharField(max_length=10, blank=True)  # Numbers only, no room for a format like "(xxx) xxx-xxxx"
