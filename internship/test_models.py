...
class TestInternshipDetails(APITestCase):
    ...
    #     internship_details = baker.make(InternshipDetails, internshipName='Embedded intern', program=self.program,
...
class TestPriority(APITestCase):
    ...
    def test_priority_model(self):
        priority1 = baker.make(Priority, internship=self.internship_details_1, Student=self.student,
                               student_priority_number=1)
        priority2 = baker.make(Priority, internship=self.internship_details_2, Student=self.student,
                               student_priority_number=2)
